# ==============================================================================
# This script performs general statistical analysis on the PLFS dataset, 
# including descriptive statistics, state-level summaries, and visualizations of 
# labor force and worker shares over time. It also computes population-weighted 
# aggregates for India as a whole.
# ==============================================================================
...
# ── 3. By state ───────────────────────────────────────────────────────────────
plfs_deep |>
  dplyr::select(state_name, all_of(share_vars)) |>
...
plfs_long <- plfs_deep |>
  dplyr::select(state_name, time, all_of(share_vars)) |>
