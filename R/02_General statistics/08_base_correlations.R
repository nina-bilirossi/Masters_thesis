# ==============================================================================
# This code checks for correlations between the main explanatory variables 
# (Drought index, Flood Index, and PR Score) and their lagged values. 

# It also calculates the Variance Inflation Factor (VIF) 
# to assess multicollinearity among these variables. 

# Additionally, it computes the partial correlation between SPEI-12 and Flood 
# Index while controlling for year fixed effects, providing insights into the 
# relationship between these two variables after accounting for temporal variations.
# ==============================================================================
