# ==============================================================================
# This code visualized the exteme precipitations thresholds calculated in python.
# Those are used in python to generate the flood index. 
# details on the methods can be found in the thesis, in the climate data section.
