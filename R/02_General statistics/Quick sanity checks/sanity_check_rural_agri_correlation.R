...
# This script compares state-level agricultural employment shares from PLFS data
# with 2011 urbanisation rates and population. It harmonises state names, merges
# the datasets, calculates Pearson correlations, and produces comparative
# scatterplots to assess relationships between urbanisation, population, and
