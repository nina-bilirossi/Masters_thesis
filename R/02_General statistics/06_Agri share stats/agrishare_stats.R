...
plot_data <- data.frame(
  ...
  Variable = c("FI", "PI", "SPEI-12", "FI", "PI", "SPEI-12", "FI", "PI", "SPEI-12"),
  Mean = c(0.276, 0.340, -0.388, 0.255, 0.284, -0.496, 0.324, 0.296, -0.330),
  SD = c(0.325, 0.533, 0.644, 0.318, 0.343, 0.774, 0.291, 0.302, 0.560)
)
...
ggplot(plot_data, aes(x = Group, y = Mean, color = Group)) +
  ...
  labs(
    ...
    subtitle = "Whiskers represent 95% Confidence Intervals (Mean ± 1.96 * SD)",
