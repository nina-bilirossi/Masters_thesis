...
# ==============================================================================
# This script computes and visualizes labor market summmary statistics for the 
# general population and for the two population subgroups
...
ggplot(chart_data, aes(x = Group, y = mean_scaled, fill = Metric)) +
  ...
  scale_y_continuous(
    name = "Working-Age Population Surveyed (Count)",
    labels = scales::comma, 
    sec.axis = sec_axis(
      transform = ~ . / scale_factor, 
      name = "Share (%)",
