...
# ==============================================================================
# This script integrates state-level agricultural employment shares from PLFS
# data with the regression dataset. It standardises state names, excludes
# selected Union Territories, calculates a standardised agricultural share
# measure, and classifies states into low- and high-agriculture groups based on
# the median agricultural share.
# ==============================================================================
...
write.csv(df_sections, "/Users/ninabilirossi/Desktop/MSC THESIS/Data works/Code/Outputs/final material/regression_dataframe_july_agri.csv", row.names = FALSE)
