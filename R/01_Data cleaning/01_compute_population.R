...
# This script estimates district-level population using gridded population data
# and administrative boundaries. It extracts population totals, exports the
# resulting district-level dataset, and visualises the spatial distribution of
