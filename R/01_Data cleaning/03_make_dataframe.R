...
# This script cleans, harmonises, and merges the flood, SPEI, population, PLFS,
# and extreme precipitation datasets into a single state-year dataframe for
# regression analysis. The resulting regression dataset is available at:
# Outputs/final material/regression_dataframe_july.csv; rerunning this script is
# not necessary unless the underlying data or processing needs to be updated.
