...
# ==============================================================================
# This script prepares the regression dataset by adding splits based on 
# agricultural share, population size, and regional classification. 

# It also computes baseline informality per state.
