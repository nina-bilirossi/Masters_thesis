...
# ==============================================================================
# COMPUTE SPEI/DROUGHT INDEX

# This script calculates district- and population-weighted state-level SPEI12
# values using gridded population and administrative boundary data. It processes
# annual SPEI raster files, generates state and district maps, and creates lagged
# SPEI variables for subsequent analysis.
