...
stargazer(
  ...
  title          = "Flood Index (FI) and Casual Labour-Force Participation by Gender (PS, Weighted)",
  dep.var.labels = c("Male Share", "Female Share"),
  omit = c("factor\\(STATE\\)",
           "factor\\(year\\)",
           "factor\\(STATE\\):year"),
...
stargazer(
  ...
  title          = "PR Index and Casual Labour-Force Participation by Gender (PS, Weighted)",
  dep.var.labels = c("Male Share", "Female Share"),
  omit = c("factor\\(STATE\\)",
           "factor\\(year\\)",
           "factor\\(STATE\\):year"),
