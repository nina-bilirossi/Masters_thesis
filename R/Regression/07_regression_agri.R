...
stargazer(
  m_agri_large_spei, m_agri_small_spei,
  m_agri_large_pr,   m_agri_small_pr,
  se             = list(se_large_spei[, 2], se_small_spei[, 2], se_large_pr[, 2],   se_small_pr[, 2]
                        ),
  p              = list(se_large_spei[, 4], se_small_spei[, 4], se_large_pr[, 4],   se_small_pr[, 4],
                        se_large_pr[, 4],   se_small_pr[, 4]),
...
stargazer(
  ...
  m_agri_large_pr, m_agri_small_pr,  
  se             = list(se_large_spei[, 2], se_small_spei[, 2],
                        se_large_fi[, 2],       se_small_fi[, 2],
                        se_large_pr[, 2],       se_small_pr[, 2]),         
  p              = list(se_large_spei[, 4], se_small_spei[, 4],
                        se_large_fi[, 4],       se_small_fi[, 4],
                        se_large_pr[, 4],       se_small_pr[, 4]),         
  title          = "Casual Labour-Force Participation by Agricultural Share of Employment",
  dep.var.caption        = "Casual Labour Share (PS)",
  dep.var.labels.include = FALSE,
  column.labels  = c("High Agri", "Low Agri", "High Agri", "Low Agri", "High Agri", "Low Agri"),  
  omit           = c("factor\\(STATE\\)", "factor\\(year\\)", "factor\\(STATE\\):year", "Constant"),
  omit.stat      = c("f", "ser"),
