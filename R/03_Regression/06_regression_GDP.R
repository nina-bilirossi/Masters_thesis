...
# 3. regressions rural urban with gdp as factor, only low income
...
se_low_spei  <- cluster_se(m_income_low_spei_urb)
se_high_fi   <- cluster_se(m_income_high_fi_urb)
se_low_fi    <- cluster_se(m_income_low_fi_urb)
se_high_pr   <- cluster_se(m_income_high_pr_urb)
se_low_pr    <- cluster_se(m_income_low_pr_urb)
