...
#
# Includes:
#   - Full sample regressions (SPEI only, FI only, SPEI + rainfall)
#   - Subgroup regressions by gender (female / male)
#   - Subgroup regressions by settlement type (rural / urban)
#   - Combined comparison tables (gender, settlement)
#
# ══════════════════════════════════════════════════════════════════════════════
