...
# flood indices in the regression models testing the AIC and BIC methods.
...
for (i in 1:3) {
  ...
  formula_str <- paste("s_casual_w_worker_W_unw ~ spei_negative +", paste(lags_to_include, collapse = " + "))
...
for (i in 1:3) {
  ...
  formula_str <- paste("s_casual_w_worker_W_unw ~ FI_state +", paste(lags_to_include, collapse = " + "))
...
for (i in 1:3) {
  ...
  formula_str <- paste("s_casual_w_worker_W_unw ~ pr_score + ", paste(lags_to_include, collapse = " + "))
