...
# This script loads the required
# statistical packages and regression dataset, prepares the panel data structure,
# creates analysis-specific datasets with selected states excluded, and defines
# clustered standard errors at the state level. It also generates descriptive
# statistics and population-weighted summary statistics for the main study
# variables.
...
data <- read.csv("/Users/ninabilirossi/Desktop/MSC THESIS/Data works/Code/Outputs/final material/regression_dataframe_july.csv") |>
