...
stargazer(
  ...
  title     = "Effect of Full SPEI on Informality",
  dep.var.labels = "Share Casual Workers (PS)",
  covariate.labels = c("SPEI-12", "SPEI-12 Lag 1", "SPEI-12 Lag 2", "SPEI-12 Lag 3"),
  omit = c("factor\\(STATE\\)",
           "factor\\(year\\)",
  ...
  notes      = " ",
  notes.append = FALSE,
  out        = file.path(out, "SPEI_full.tex"),
  type       = "latex",
  label      = "tab:full_spei"
)
