...
use "/Users/ninabilirossi/Desktop/MSC THESIS/Data works/My data prep/PLFS India/PLFS_Data_2019-20/Download_dta/PERFV_2019-20.dta", clear
...
gen data="PLFS_1920"
gen time="July 2019 - June 2020"

*Add state names
merge 1:1 state_per_fv using "/Users/ninabilirossi/Desktop/MSC THESIS/Data works/Shared with me/PLFS India/PLFS_Data_2019-20/Download_dta/State_names.dta"
assert _merge==3 if !inlist(state_per_fv, "0134", "25", "26", "2526")
drop if state_per_fv=="25" | state_per_fv=="26" 
drop _merge

rename state_per_fv state_code_1920

replace state_name="LADAKH" if state_code_1920=="0134"
replace state_name="D & N. HAVELI & DAMAN & DIU" if state_code_1920=="2526"
...
save "/Users/ninabilirossi/Desktop/MSC THESIS/Data works/My data prep/PLFS processed/PLFS_1920_State_N_${string_weight}.dta", replace
