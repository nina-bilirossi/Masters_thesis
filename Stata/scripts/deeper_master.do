...
keep  s_casual_w_worker_P_m_unw ///
		s_casual_w_worker_PS_m_unw ///
		s_casual_w_worker_P_f_unw ///
		s_casual_w_worker_PS_f_unw ///
		s_casual_w_worker_P_unw ///
		s_casual_w_worker_PS_unw ///
		s_casual_w_worker_P_rur_unw ///
		s_casual_w_worker_PS_rur_unw ///
		s_casual_w_worker_P_urb_unw ///
		s_casual_w_worker_PS_urb_unw ///
		s_casual_w_lf_P_m_unw ///
		...
		labor_force_PS_${string_weight} ///
        pop_tot_${string_weight} ///
		pop_workingage_${string_weight} ///
        worker_PS_${string_weight} ///
        labor_force_PS_m_${string_weight} labor_force_PS_f_${string_weight} ///
        labor_force_PS_urb_${string_weight} labor_force_PS_rur_${string_weight} ///
        worker_PS_m_${string_weight} worker_PS_f_${string_weight} ///
        worker_PS_urb_${string_weight} worker_PS_rur_${string_weight} ///
		s_casual_w_worker_WD_m_unw ///
		s_casual_w_worker_W_m_unw ///
		s_casual_w_worker_WD_f_unw ///
		s_casual_w_worker_W_f_unw ///
		s_casual_w_worker_WD_unw ///
		s_casual_w_worker_W_unw ///
		s_casual_w_worker_WD_rur_unw ///
		s_casual_w_worker_W_rur_unw ///
		s_casual_w_worker_WD_urb_unw ///
		s_casual_w_worker_W_urb_unw ///
		s_casual_w_lf_WD_m_unw ///
		s_casual_w_lf_W_m_unw ///
		s_casual_w_lf_WD_f_unw ///
		s_casual_w_lf_W_f_unw ///
		s_casual_w_lf_WD_unw ///
		s_casual_w_lf_W_unw ///
		s_casual_w_lf_WD_rur_unw ///
		s_casual_w_lf_W_rur_unw ///
		s_casual_w_lf_WD_urb_unw ///
		s_casual_w_lf_W_urb_unw ///
		labor_force_W_${string_weight} ///
        pop_tot_${string_weight} ///
		pop_workingage_${string_weight} ///
        worker_W_${string_weight} ///
        labor_force_W_m_${string_weight} labor_force_W_f_${string_weight} ///
        labor_force_W_urb_${string_weight} labor_force_W_rur_${string_weight} ///
        worker_W_m_${string_weight} worker_W_f_${string_weight} ///
        worker_W_urb_${string_weight} worker_W_rur_${string_weight} ///
        pop_m_${string_weight} pop_f_${string_weight} ///
        pop_urb_${string_weight} pop_rur_${string_weight} ///
		data ///
		time ///
		state_name

* Generate labor force and worker shares
gen lf_share_${string_weight}     = labor_force_PS_${string_weight} / pop_workingage_${string_weight}
gen worker_share_${string_weight} = worker_PS_${string_weight}      / pop_workingage_${string_weight}

foreach x in m f urb rur {
    gen lf_share_`x'_${string_weight}     = labor_force_PS_`x'_${string_weight} / pop_`x'_${string_weight}
    gen worker_share_`x'_${string_weight} = worker_PS_`x'_${string_weight}       / pop_`x'_${string_weight}
}
...
save "weekly_PLFS_all_s_N_${string_weight}.dta", replace
export delimited using "weekly-PLFS_all_s_N_${string_weight}.csv", replace
