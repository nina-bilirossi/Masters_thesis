...
use "/Users/ninabilirossi/Desktop/MSC THESIS/Data works/My data prep/PLFS India/PLFS_Data_2020-21/Download_dta/perv1.dta", clear
...
**# Bookmark #1
tostring b6q4_3pt2, gen(b6q4_3pt2_str)
drop b6q4_3pt2
rename b6q4_3pt2_str b6q4_3pt2
replace b6q4_3pt2="" if b6q4_3pt2=="."
 
tostring b6q4_act2_3pt6_perv1, gen(b6q4_act2_3pt6_perv1_str)
drop b6q4_act2_3pt6_perv1
rename b6q4_act2_3pt6_perv1_str b6q4_act2_3pt6_perv1
replace b6q4_act2_3pt6_perv1="" if b6q4_act2_3pt6_perv1=="."
...
replace state_perv1="0134" if state_perv1=="01" & (distcode_perv1=="03"|distcode_perv1=="04" )
...
replace state_perv1="2526" if state_perv1=="25" |  state_perv1=="26" 
...
gen data="PLFS_2021"
gen time="July 2020 - June 2021"

*Add state names
merge 1:1 state_perv1 using "/Users/ninabilirossi/Desktop/MSC THESIS/Data works/My data prep/PLFS India/PLFS_Data_2020-21/Download_dta/State_names.dta"
**# Bookmark #2
assert _merge==3 if !inlist(state_perv1, "0134", "25", "26", "2526")  //undo: if state_perv1!="36" --> only use if adding  Telangana to Andhra Pradesh
drop if state_perv1=="25" | state_perv1=="26" 
*undo: drop if state_perv1=="36" --> only use if adding  Telangana to Andhra Pradesh
drop _merge

rename state_perv1 state_code_2021

replace state_name="LADAKH" if state_code_2021=="0134"
replace state_name="D & N. HAVELI & DAMAN & DIU" if state_code_2021=="2526"
...
save "/Users/ninabilirossi/Desktop/MSC THESIS/Data works/My data prep/PLFS processed/PLFS_2021_State_N_${string_weight}.dta", replace
